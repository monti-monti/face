...
def printimg(imgs):
    ...
    for bbox in bboxes:
        ...
        # <class 'numpy.ndarray'> (1, 2)  [[9.9999917e-01 8.6268375e-07]]  变化的值
        ...
        # [4.5557402e-07 1.9009208e-06 2.8783199e-04 9.9841607e-01 1.5261240e-04 1.0924522e-03 1.3928890e-05 3.4708322e-05]
        # print("*********", agePreds[0])
        ...
        # cv.imwrite('./static/image/text.jpg', frameFace)
        # print("time : {:.3f} ms".format(time.time() - t))
        result = "年龄 : {}，概率 = {:.3f}%，性别 : {}，概率 = {:.3f}%".format(age, agePreds[0].max() * 100, gender,
                                                                    genderPreds[0].max() * 100)
        return result
